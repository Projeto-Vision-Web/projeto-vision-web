  ...
  main.dashboard-grid
    ...
    .insights-top-grid
      .chart-card.small
        ...
        .chart-legend-pie
          p.legend-item-pie Muito Satisfeito: 35%
          p.legend-item-pie Satisfeito: 40%
          p.legend-item-pie Neutro: 15%
          p.legend-item-pie Muito Insatisfeito: 3%
          p.legend-item-pie Insatisfeito: 7%
    ...
    .insights-container
      ...
      .insights-list
        .insight-card.success-insight
          span.insight-icon
          div
            h4 Melhoria Significativa em Comunicação
            p A categoria "Comunicação" apresentou crescimento de 8 pontos no último trimestre. As iniciativas de transparência e reuniões periódicas estão surtindo efeito positivo.

        .insight-card.warning-insight
          span.insight-icon
          div
            h4 Atenção: Reconhecimento Profissional
            p A categoria "Reconhecimento" apresenta a menor pontuação (58 pts). Recomenda-se implementar programa de valorização e feedback mais frequente.

        .insight-card.info-insight
          span.insight-icon
          div
            h4 Alta Taxa de Participação
            p Com 87% de participação, a empresa demonstra forte engajamento dos colaboradores com o processo de pesquisa, superando a média do mercado (65%).
</template>
    ...
    onMounted(() => {
      ...
      new Chart(document.getElementById('lineChart').getContext('2d'), {
        ...
        options: {
          ...
          scales: {
            ...
            y: { beginAtZero: true, max: 100, grid: { color: '#333355' }, ticks: { color: '#f0f0f0' } }
          },
      ...
      new Chart(document.getElementById('doughnutChart').getContext('2d'), {
        ...
        data: {
          ...
          datasets: [{
            data: [35, 40, 15, 7, 3],
            backgroundColor: ['#9c27b0', '#5d50c6', '#a0a0c0', '#ff416c', '#ffc107'],
            borderWidth: 0
          }]
        },
        options: {
      ...
      new Chart(document.getElementById('radarChart').getContext('2d'), {
        type: 'radar',
        data: {
          labels: ['Liderança', 'Ambiente', 'Benefícios', 'Crescimento', 'Comunicação', 'Reconhecimento'],
          datasets: [{
            label: 'Período Atual',
            data: [8, 7, 6, 8, 9, 5.8],
